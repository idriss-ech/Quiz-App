...
import { IonCard, IonCardContent, IonCardHeader, IonCardTitle, IonList, IonItem, IonRadioGroup, IonRadio, IonIcon } from '@ionic/react';
...
const QuestionCard: React.FC<QuestionCardProps> = ({ question, selectedChoiceId, onChoiceSelect }) => {
  ...
  return (
    <IonCard className="question-card" style={{ borderRadius: '16px', boxShadow: '0 4px 16px rgba(0,0,0,0.1)' }}>
      <IonCardHeader>
        <IonCardTitle className="ion-text-center" style={{ fontSize: '1.2rem', fontWeight: '600' }}>
          {question.text}
        </IonCardTitle>
      </IonCardHeader>
      <IonCardContent>
